...
from .views import HomeView, AboutUsView, PrivacyPolicyView, TermsAndConditionView, GoogleSearchConsoleView
...
urlpatterns = [
    ...
    path('google2f18d2468a4ed341', GoogleSearchConsoleView.as_view(), name='google_search_console_view')
]
